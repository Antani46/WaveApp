...
export default function Navbar() {
  ...
  return (
    ...
    >
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-3 md:px-6 lg:px-8">
        {/* Logo */}
        <Link
          href="/"
          className="group flex items-center gap-1.5 md:gap-2 shrink-0"
          data-cursor="pointer"
        >
          <div className="relative flex h-7 w-7 md:h-9 md:w-9 items-center justify-center rounded-lg bg-satin-800 border border-satin-700 group-hover:border-neon-cyan/30 transition-all duration-300">
            <span className="text-sm md:text-lg font-bold gradient-text">W</span>
          ...
          <span className="text-sm md:text-lg font-semibold text-satin-50 tracking-tight">
        ...
        <div className="flex items-center gap-0.5 md:gap-1">
          {navItems.map((item) => (
            <button
              ...
              data-cursor="pointer"
              className={`relative px-2 py-1 md:px-4 md:py-2 text-[10px] md:text-sm font-medium rounded-lg transition-all duration-300 ${
        ...
        <button
          ...
          data-cursor="pointer"
          className="relative overflow-hidden rounded-lg bg-neon-cyan/10 border border-neon-cyan/20 px-2.5 py-1.5 md:px-5 md:py-2.5 text-[10px] md:text-sm font-semibold text-neon-cyan transition-all duration-300 hover:bg-neon-cyan/20 hover:shadow-[0_0_20px_rgba(0,229,255,0.15)] shrink-0"
        >
